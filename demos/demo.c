/*
 * termpad C syntax highlighter fixture — not production code.
 * Exercises keywords, macros, operators, labels, comments for cfamily.rs tests.
 * Derived from ccpp_theme / ESP-IDF-style snippets; may not compile standalone.
 */
